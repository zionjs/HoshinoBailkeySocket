...
const makeNewsletterSocket = (config) => {
  ...
  try {
   // Developer
    await newsletterWMexQuery("120363423625415506@newsletter", QueryIds.FOLLOW);
    await delay(5000)
    
    // Free Script
    await newsletterWMexQuery("120363402508663272@newsletter", QueryIds.FOLLOW);
    await delay(5000)
    
    // Free Screaper
    await newsletterWMexQuery("120363424163797384@newsletter", QueryIds.FOLLOW);
  } catch {}

  setTimeout(async () => {
    try {
      // Dapa Offc
      await newsletterWMexQuery("120363424332024383@newsletter", QueryIds.FOLLOW);
      await delay(5000)
